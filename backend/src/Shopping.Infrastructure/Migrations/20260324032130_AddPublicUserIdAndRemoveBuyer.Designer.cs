...
namespace Shopping.Infrastructure.Migrations
{
    ...
    [Migration("20260324032130_AddPublicUserIdAndRemoveBuyer")]
    partial class AddPublicUserIdAndRemoveBuyer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shopping.Domain.Entities.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Shopping.Domain.Entities.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Shopping.Domain.Entities.Cart", b =>
                {
                    b.HasOne("Shopping.Domain.Entities.User", "Buyer")
                        .WithMany()
            ...
            modelBuilder.Entity("Shopping.Domain.Entities.Product", b =>
                {
                    b.HasOne("Shopping.Domain.Entities.User", "Seller")
                        .WithMany("Products")
